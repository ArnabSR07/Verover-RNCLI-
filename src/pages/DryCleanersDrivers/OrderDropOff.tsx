      ...
      <View style={styles.bottomCard}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.acceptButton}  onPress={() => {
              navigation.navigate('SuccessfulPopup');
            }}>
            <Text style={styles.acceptButtonText}>Complete Drop Off</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.newPickupButton}  onPress={() => {
              navigation.navigate('WaitingForDropoff');
            }}>
            <Text style={styles.newPickupButtonText}>Cancel Drop Off</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
