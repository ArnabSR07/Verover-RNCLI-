    ...
    <View style={styles.cardContent}>
      ...
      <View style={styles.cleanerInfo}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailItem}>
            <Icon source="clock" size={12} color="#666" />
            <Text style={styles.detailText}>
...
const CleanerDetailsModal = ({ 
  ...
  const handleContinue = () => {
    if (cleaner) {
      onSelect(cleaner);
      onClose();
      navigation.navigate('NumberofItems', { selectedCleaner: cleaner });
    }
  };
      ...
      <SafeAreaView style={styles.modalContainer}>
        <View style={styles.modalHeader}>
          <TouchableOpacity onPress={onClose} style={styles.backButton}>
            <Icon source="arrow-left" size={24} color="#FF8C00" />
          </TouchableOpacity>
          ...
          <View style={styles.shopImageContainer}>
            {cleaner.shopimage && cleaner.shopimage.length > 0 ? (
              ...
              <View style={styles.shopImagePlaceholder}>
                <Icon source="store" size={40} color="#ccc" />
            ...
            <View style={styles.detailCardHeader}>
              ...
              <View style={styles.detailInfo}>
                ...
                <View style={styles.detailMetrics}>
                  ...
                  <View style={styles.detailMetricItem}>
                    <Icon source="clock" size={14} color="#666" />
                    <Text style={styles.detailMetricText}>
                      {schedule.length > 0
  ...
  const fetchDryCleaners = async () => {
    try {
      ...
      const response = await axios.get(
        'http://localhost:5000/api/users/dry-cleaner',
        {
          headers: {
