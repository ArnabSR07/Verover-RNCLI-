      ...
      >
        ...
        <View style={styles.bookingFooter}>
          <TouchableOpacity style={styles.viewDetailsButton}>
            ...
            <Icon name="arrow-forward-ios" size={12} color="#FF8C00" />
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={handleRefresh} style={styles.refreshButton}>
            <Icon name="refresh" size={24} color="#FF8C00" />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.trackBanner}>
            <Icon name="location-on" size={16} color="#fff" style={styles.bannerIcon} />
          ...
          {selectedOrder.scheduledPickupDateTime && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Icon name="schedule" size={20} color="#FF8C00" />
          ...
          {selectedOrder.scheduledDeliveryDateTime && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Icon name="local-shipping" size={20} color="#FF8C00" />
          ...
          {(selectedOrder.pickupAddress || selectedOrder.dropoffAddress) && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Icon name="place" size={20} color="#FF8C00" />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Icon name="qr-code" size={20} color="#FF8C00" />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Icon name="list" size={20} color="#FF8C00" />
