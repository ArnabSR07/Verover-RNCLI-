...
const initialState: UnsafeStopsState = {
    unsafeStops: [
        { id: 1, title: 'Joshua Terminal, NY', description: 'Thieves & Goons\nConstruction Work in Progress\nInsufficient Cleaning', time: '30 mins in Bus' },
        { id: 2, title: 'Joshua Terminal, NY', description: 'Thieves & Goons\nConstruction Work in Progress\nInsufficient Cleaning', time: '30 mins in Bus' },
    ],
};
